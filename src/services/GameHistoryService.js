      ...
      const games = result.rows.map(row => {
        ...
        if (includeVrfDetails && row.transaction_hash) {
          game.vrfDetails = {
            ...
            verifiable: true,
            verificationNote: "This result was generated using Chainlink VRF - click to verify on Etherscan"
          };
        }
  ...
  async verifyGameResult(gameId) {
    ...
    try {
      ...
      return {
        ...
        message: 'Game result is verifiable on-chain via Chainlink VRF'
      };

    ...
    >
      ...
      <div className={
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight">
                        Enter the Arbitrum Gaming <br /> Arena:{" "}
        ...
        <h2 className="text-[#B3B3B3] mt-4 text-lg sm:text-xl leading-relaxed max-w-2xl">
          Dive into the next generation of gaming with APT-Casino – where every move is powered by <span className="text-white font-semibold">Arbitrum Blockchain</span>. Discover new games, connect
